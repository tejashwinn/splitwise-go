...
CREATE TABLE SW_GRP (
    OBJECT_ID BIGSERIAL PRIMARY KEY,
    GRP_NAME VARCHAR (1000) UNIQUE NOT NULL,
    GRP_DESCRITPION VARCHAR (1000) NOT NULL,
    CUR_ID BIGSERIAL NOT NULL,
    CREATED_AT TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CREATED_BY_USR_ID BIGSERIAL NOT NULL,
    UPDATED_AT TIMESTAMP,
    UPDATED_BY_USR_ID BIGSERIAL
);
CREATE TABLE SW_GRP_USR (
    OBJECT_ID BIGSERIAL PRIMARY KEY,
